	...
	*/
	...
	switch (_preset){
	    case BktGlitchPreset.A:       
	        bktglitch_set_intensity(1.400000);
bktglitch_set_line_shift(0.002333);
bktglitch_set_line_speed(0.006667);
bktglitch_set_line_resolution(0.460000);
bktglitch_set_line_drift(0.020000);
bktglitch_set_line_vertical_shift(0.000000);
bktglitch_set_noise_level(0.193333);
bktglitch_set_jumbleness(0.053333);
bktglitch_set_jumble_speed(0.000000);
bktglitch_set_jumble_resolution(0.000000);
bktglitch_set_jumble_shift(0.013333);
bktglitch_set_channel_shift(0.002667);
bktglitch_set_channel_dispersion(0.010000);
bktglitch_set_shakiness(0.133333);
bktglitch_set_rng_seed(0.040000);
	    break;    
