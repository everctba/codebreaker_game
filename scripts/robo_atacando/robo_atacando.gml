...
if (delay < 0) and (distance_to_object(obj_player) < 10) { //place meenting é se ele tiver se colidindo com o player ent ele vai tirar dando do 
...
if (distance_to_object(obj_player) >= 10){ // se ele não tiver, ele vai voltar em modo de perseguição
